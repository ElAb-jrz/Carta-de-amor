...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Tu chiquito ";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-01-05T00:00:00'); 
  ...
  function update() {
    ...
    container.innerHTML =
      `Tiempo juntos: <b>${days}</b> días<br>` +
      `Tiempo restante para nuestro primer año: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
